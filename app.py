    ...
    projects = [
        {
            ...
            "link":"intelligentspamham-detector-system-c36fxk8ajousbjsjyjqrhr"
        },
        {
        ...
        },
        {
            ...
            "link": "movie-recommendation-system-ggagluh2fnkgqdawihfgxl"
        },
        {
...
# ===== Education Section =====
    ...
    <ul style='font-size:20px;'>
        ...
        <li>  Arts – South Point Public School (2020)</li>
    </ul>
    """, unsafe_allow_html=True)
